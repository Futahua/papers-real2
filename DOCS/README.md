...
* `PAPERS_BACKPACK_DESK_V1.txt` — the Desk: an optional per-Backpack active-work surface (first-form concept; amended 2026-07-10 — an affordance a Backpack offers, not what a Backpack is, and in-place note revision generalized to a Backpack capability)
