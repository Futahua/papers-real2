...
A Backpack can put work on its **Desk** — an optional active-work surface (see
...
as much a Backpack.
Any AI-made Backpack note can be revised in place under the creator's direction — a
guarded Backpack capability (exact preview of the note text, your direction, and each
